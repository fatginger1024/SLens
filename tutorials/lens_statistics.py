...
class lensplot(gnfwSersic):
    ...
    def plot_Sigma(self,write=False):
        ...
        ax.loglog(self._x,Sigma_gnfw,ls='-',color='rebeccapurple',label="gnfw",zorder=1) 
        ax.loglog(self._x,Sigma_galaxy,ls='-',color='orangered',label="Sersic",zorder=1) 
    ...
    def plot_alpha(self,write=False):
        ...
        ax.loglog(self._x,alpha_gnfw,ls='-',color='rebeccapurple',label="gnfw",zorder=1) 
        ax.loglog(self._x,alpha_galaxy,ls='-',color='orangered',label="Sersic",zorder=1) 
    ...
    def plot_beta(self,write=False):
        ...
        ax.plot(np.concatenate((-self._x[::-1],0,self._x),axis=None),
                ...
                ls='-',color='rebeccapurple',label="gnfw",zorder=1) 
        ax.plot(np.concatenate((-self._x[::-1],0,self._x),axis=None),
                np.concatenate((-beta_galaxy[::-1],0,beta_galaxy),axis=None),
                ls='-',color='orangered',label="Sersic",zorder=1) 
    ...
    def plot_kappa(self,write=False):
        ...
        ax.loglog(self._x,kappa_gnfw,ls='-',color='rebeccapurple',label="gnfw",zorder=1) 
        ax.loglog(self._x,kappa_galaxy,ls='-',color='orangered',label="Sersic",zorder=1) 
    ...
    def plot_gamma(self,write=False):
        ...
        ax.loglog(self._x,gamma_gnfw,ls='-',color='rebeccapurple',label="gnfw",zorder=1) 
        ax.loglog(self._x,gamma_galaxy,ls='-',color='orangered',label="Sersic",zorder=1) 
        ax.set_title("Shear")
        ax.set_xlabel('x')
